...
if user_menu =='Athlete wise analysis':
    ...
    fig = ff.create_distplot([x1, x2, x3, x4], ['Overall Age', 'Gold Meadlist', 'Silver Meadlist', 'Bronze Meadlist'], show_hist=False, show_rug=False)
    ...
    fig, ax = plt.subplots()
    ax = sns.scatterplot(athlete_df['Weight'], athlete_df['Height'], hue=temp_df['Medal'], style=temp_df['Sex'], s=55)
